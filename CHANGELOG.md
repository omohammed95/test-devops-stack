...
## [1.7.0](https://github.com/omohammed95/test-devops-stack/compare/v1.9.0...v1.7.0) (2024-06-21)


### ⚠ BREAKING CHANGES

* **eks:** send http traffic on NLB to port 80 on cluster ([#810](https://github.com/omohammed95/test-devops-stack/issues/810))
* **argocd:** upgrade ArgoCD charts and use new repositories spec ([#741](https://github.com/omohammed95/test-devops-stack/issues/741))
...
* **aad-pod-identity:** create identities Namespaces ([0358f2d](https://github.com/omohammed95/test-devops-stack/commit/0358f2d5ad55e42892d41a053150b99f8a088375))
...
* add conventional commits check ([63c7f39](https://github.com/omohammed95/test-devops-stack/commit/63c7f398e1d9463685b094a19a2950b5480bdaec))
...
* add http01 solver for acme for AKS and EKS ([ff3188c](https://github.com/omohammed95/test-devops-stack/commit/ff3188c567db0061a4a12412241e49addef3b28a))
* Add initial support for OpenTelekomCloud's CCE ([a7e374b](https://github.com/omohammed95/test-devops-stack/commit/a7e374bdae98da58548902f2ef80c49b104e0394))
* add new cluster eks for testing ([5cd2266](https://github.com/omohammed95/test-devops-stack/commit/5cd2266f419ab1357cddb3e13d6d1fe2f76093d7))
* add Release Please Action ([aa781ec](https://github.com/omohammed95/test-devops-stack/commit/aa781ecf3b2d8e25fdcca465a1bd9af4165998c4))
* add support for tfmigrate in gitlab ci pipeline ([1654a78](https://github.com/omohammed95/test-devops-stack/commit/1654a784b9abad7c77c3de88695a10c99a25718a))
* add support to deploy ApplicationSets ([ea3a930](https://github.com/omohammed95/test-devops-stack/commit/ea3a930adb56b0741f0ed4d2d1e94051821cd3fa))
...
* **aks:** add kube_admin_config output ([b0fa82d](https://github.com/omohammed95/test-devops-stack/commit/b0fa82da16f7c7edbd244b9dcb2b5fa5e7b28df7))
* **aks:** add kubelet identity to outputs ([f883650](https://github.com/omohammed95/test-devops-stack/commit/f883650310fbd6e6828af4531d9ddf1855599653))
* **aks:** add support for node pools in AKS ([edb9813](https://github.com/omohammed95/test-devops-stack/commit/edb981339ef566e21ae16338bc7e6c17699da9d9))
* **aks:** create UAI and corresponding AzureIdentities and AzureIdentityBindings ([6f19e1f](https://github.com/omohammed95/test-devops-stack/commit/6f19e1fd86907ae696a3621650ff14adddb3f196))
...
* **aks:** extend accepted params for node pools ([#780](https://github.com/omohammed95/test-devops-stack/issues/780)) ([831557f](https://github.com/omohammed95/test-devops-stack/commit/831557fe323b2bb90ae70685c6b4c0cd0fe9de6c))
* **aks:** set kubernetes version to current default ([4580f26](https://github.com/omohammed95/test-devops-stack/commit/4580f2631b70da36a71b73c0acae8aa386fd6dcd))
* **aks:** upgrade Azure/aks/azurerm module to 4.13.0 ([f47168c](https://github.com/omohammed95/test-devops-stack/commit/f47168c796fee935b36c7afacad5527ef2c9ce87))
* **aks:** upgrade azurerm provider to 2.62.1 ([c25accc](https://github.com/omohammed95/test-devops-stack/commit/c25accc12f0ab0f740894b469a8041e04cd76997))
...
* allow to configure ArgoCD repositories ([aaa6d11](https://github.com/omohammed95/test-devops-stack/commit/aaa6d113d95569b969f01f86104850dee3258e88))
* allow to deploy extra AppProject objects ([a57099b](https://github.com/omohammed95/test-devops-stack/commit/a57099b6f8131795a0b17839d62a83db0b71d6b4))
* allow to disable wait_for_app_of_apps ([a01303b](https://github.com/omohammed95/test-devops-stack/commit/a01303bcce252e40a2cf063d7fb2bd58aa4e58c2))
* allow to set AppProject's status ([3c3d6e0](https://github.com/omohammed95/test-devops-stack/commit/3c3d6e0df136dfe7c3ccb95ebbe934ec70d15b5b))
* **antora:** use lunr generator in github action for building documentation search index ([2307150](https://github.com/omohammed95/test-devops-stack/commit/23071502923435ac4aef026858f3ae3f49aa748b))
...
* **argocd-applicationset:** upgrade chart version to 1.0.0 ([16fee9d](https://github.com/omohammed95/test-devops-stack/commit/16fee9d65a4310141c0d9b8932cfe5de393a1e9d))
* **argocd-notifications:** upgrade chart version to 1.4.1 ([da3f52c](https://github.com/omohammed95/test-devops-stack/commit/da3f52c5722c88660d7d40241f9991aae1df0344))
...
* **argocd:** upgrade ArgoCD charts and use new repositories spec ([#741](https://github.com/omohammed95/test-devops-stack/issues/741)) ([d4979c7](https://github.com/omohammed95/test-devops-stack/commit/d4979c7808ccddecbda1a5bb431a05bc2f4428ff))
* **argocd:** upgrade ArgoCD components ([588124a](https://github.com/omohammed95/test-devops-stack/commit/588124ac9e908b58e360546692b71c014c8cf7b7))
* **argocd:** upgrade to v2.0.5 ([f467290](https://github.com/omohammed95/test-devops-stack/commit/f467290c965de75f7d7580da52d71dbb886cbc4b))
* **argocd:** upgrade to v2.1.0 ([3479d25](https://github.com/omohammed95/test-devops-stack/commit/3479d2569d30c9eb71dcefa95244babc9758d712))
* **aws:** add test example ([7ddef46](https://github.com/omohammed95/test-devops-stack/commit/7ddef46ae4c07d57bea85355059bb7980adb5c63))
* **aws:** use nip.io by default ([947380c](https://github.com/omohammed95/test-devops-stack/commit/947380c9a2db763d380e3e11cc7d9384bbee4978))
* **azuread:** upgrade provider version 1.5.0 ([ce3f66d](https://github.com/omohammed95/test-devops-stack/commit/ce3f66da34082285c83a49dbc92e3575360b00f8))
...
* **cert-manager:** parameterize clusterissuers to allow overriding parameters ([a6fcb9b](https://github.com/omohammed95/test-devops-stack/commit/a6fcb9b7c9e8b0e6bfc1458ea1e0757821452022))
* **cert-manager:** upgrade cert-manager to v1.4.3 ([3bc9c77](https://github.com/omohammed95/test-devops-stack/commit/3bc9c77616d45c13b85daa2a21b01206683b8be6))
* change ArgoCD's default policy from read-only to none ([8bc9cda](https://github.com/omohammed95/test-devops-stack/commit/8bc9cdaa9712ad12c0a951cd63e274c0be8d7de9))
...
* create dedicated AppProject for DevOps Stack Applications ([eadeaca](https://github.com/omohammed95/test-devops-stack/commit/eadeacad677a7c6dc580d35d3e9f78536cc27c82))
* **csi-secrets-store-provider-azure:** upgrade to 0.2.0 ([9a86472](https://github.com/omohammed95/test-devops-stack/commit/9a86472dd102c114f3e1df360870db9bd00c2ac3))
* **docs:** add SKS quickstart ([#784](https://github.com/omohammed95/test-devops-stack/issues/784)) ([e26a5f1](https://github.com/omohammed95/test-devops-stack/commit/e26a5f18fab283b35548629eac2d9b3b2b9e2275))
* **docs:** generate docs for Thanos chart ([09802b0](https://github.com/omohammed95/test-devops-stack/commit/09802b0dc7a8edf7d3e6ca6aaee9d6c1af94b544))
...
* **eks:** add cluster-autoscaler ([0c1d486](https://github.com/omohammed95/test-devops-stack/commit/0c1d486493f821561a50b65e546f734f675fabbd))
...
* **eks:** expose map_accounts and map_users arguments ([501e3b5](https://github.com/omohammed95/test-devops-stack/commit/501e3b5c417715de2c973767ef773043bac201c1))
* enable support for network policy in azure ([ff14031](https://github.com/omohammed95/test-devops-stack/commit/ff14031467ab0a6eb6f6a284f906858397ed39f7))
...
* **grafana:** set default users role to Editor ([cd95c03](https://github.com/omohammed95/test-devops-stack/commit/cd95c03dbf73a41c88fd811fe093ab18afe96da2))
* **k3s-docker:** add registry mirror for ghcr.io ([2d26d03](https://github.com/omohammed95/test-devops-stack/commit/2d26d0325478e59ec1d07fd8c24066a1843aa8cd))
* **k3s-docker:** upgrade K3s to v1.20.7-k3s1 ([af1d43d](https://github.com/omohammed95/test-devops-stack/commit/af1d43ddd3d3af26cc4ceae3b339dedd0a64fb9e))
* **k3s-libvirt:** upgrade k3os to v0.20.7-k3s1r0 ([873c72b](https://github.com/omohammed95/test-devops-stack/commit/873c72b2553b11d5dde1335230546a4b43c9120e))
* **k3s:** add Keycloak's admin password to Terraform outputs ([305eb67](https://github.com/omohammed95/test-devops-stack/commit/305eb670b5ea70c650eaf25a849ddb293c95a2a6))
* **k3s:** upgrade camptocamp/k3s/docker module ([0c419db](https://github.com/omohammed95/test-devops-stack/commit/0c419dbce706c12018d0bed6f3fe670d0d76bd7b))
* **k3s:** upgrade K3s to 1.20.10+k3s1 ([6477ac6](https://github.com/omohammed95/test-devops-stack/commit/6477ac6be446392d8fa87a8823968125395574cf))
* **k3s:** use minio as unique storage solution for Loki ([131beb2](https://github.com/omohammed95/test-devops-stack/commit/131beb2bf48702240b300840d50de81a3644962a))
...
* **keycloak:** rename client to devops-stack-applications ([ead90c7](https://github.com/omohammed95/test-devops-stack/commit/ead90c7502e23fb1b23fcf20478cd07c225cd943))
* **keycloak:** rename user=admin to user=jdoe ([7ad68c5](https://github.com/omohammed95/test-devops-stack/commit/7ad68c5314a1073e5dd6dc04eaca2b418d4585ed))
* **keycloak:** upgrade to v15.0.1 ([c7dfdbb](https://github.com/omohammed95/test-devops-stack/commit/c7dfdbb9a998729b090168d1fa0405f4d3ee5666))
* **keycloak:** use embedded H2 database for Keycloak ([1c52e9b](https://github.com/omohammed95/test-devops-stack/commit/1c52e9b02059b7037bad8512c241c1d8cdcd61e1))
...
* **kube-prometheus-stack:** upgrade chart to 18.0.1 ([#743](https://github.com/omohammed95/test-devops-stack/issues/743)) ([103dfc6](https://github.com/omohammed95/test-devops-stack/commit/103dfc67be8bfd0ee72ebd6fda60507211fdf163))
* **kube-prometheus-stack:** upgrade to 17.2.1 ([e065fd6](https://github.com/omohammed95/test-devops-stack/commit/e065fd65cfe1730fc94c2d1b7d98b9f45dd6aa18))
* **kube-prometheus-stack:** upgrade to v18.0.0 ([3a299ed](https://github.com/omohammed95/test-devops-stack/commit/3a299edb4aebdd417903c153f355630b7b6e7f8b))
...
* **loki-stack:** add monitoring when filebeat logging is enabled ([5038df4](https://github.com/omohammed95/test-devops-stack/commit/5038df422e4f0dbdc2594ce5735876d090476119))
* **loki:** upgrade v2.2.0 ([55ca7e2](https://github.com/omohammed95/test-devops-stack/commit/55ca7e242382ac82fc49e32100b9a53b90812739))
* manage EFS in ews/eks only ([233984f](https://github.com/omohammed95/test-devops-stack/commit/233984fb35219f7b030b77617c030230ae4880a8))
...
* **oauth2-proxy:** upgrade to v7.1.3 ([3c16e67](https://github.com/omohammed95/test-devops-stack/commit/3c16e67b05c4b2c4cf3231c9d5caf58f0ef3b394))
* output clusterid. This is used for group management ([eee0c74](https://github.com/omohammed95/test-devops-stack/commit/eee0c74453a94a5abc40e3c417abbfcf91072f3f))
* randomize argocd admin password ([1cf91f0](https://github.com/omohammed95/test-devops-stack/commit/1cf91f0aee30d369bc8ea8d0ad2a43c714c18a70))
* set CreateNamespace=true syncOption ([53bcc64](https://github.com/omohammed95/test-devops-stack/commit/53bcc649b5d16af7b58c56465a5c8bd9cbc0b3ac))
* sks example ([7031bf9](https://github.com/omohammed95/test-devops-stack/commit/7031bf9c5f6248c536bc1bc7c1f420362e08af39))
...
* **sks:** add experimental SKS support ([7e5e929](https://github.com/omohammed95/test-devops-stack/commit/7e5e9294b675c01bd8ac211c242e6cdcbc57ee5c))
* **sks:** add node anti-affinity on router nodes for cert-manager ([#753](https://github.com/omohammed95/test-devops-stack/issues/753)) ([dc3a4a3](https://github.com/omohammed95/test-devops-stack/commit/dc3a4a35f6b1250d852440d165b3775ce700aa6d))
...
* **sks:** add output for nlb ip address ([35d4ba9](https://github.com/omohammed95/test-devops-stack/commit/35d4ba9cca1a022eaecad63a3083659fe72c0132))
...
* **sks:** use Kubernetes 1.21.4 by default ([a95d813](https://github.com/omohammed95/test-devops-stack/commit/a95d8135e962a03bf2a12845815af1af94cc2469))
* **sks:** use letsencrypt-prod when there is more than 1 node pool ([#754](https://github.com/omohammed95/test-devops-stack/issues/754)) ([0f8179c](https://github.com/omohammed95/test-devops-stack/commit/0f8179c0d83654442e658ead302ffd5f995a563d))
* **terraform:** upgrade to v1.0.4 ([d2984e4](https://github.com/omohammed95/test-devops-stack/commit/d2984e418a541824d1960e1346a42251d0d6852b))
...
* **traefik:** upgrade to 2.4.13 ([f26a32e](https://github.com/omohammed95/test-devops-stack/commit/f26a32e25464f0572035bf8b72b2524128218466))
...
* upgrade aad-pod-identity to v1.8.0 ([2865a40](https://github.com/omohammed95/test-devops-stack/commit/2865a4002f39830f4f26aa5a93e263db9f89be0d))
* upgrade azurerm provider to 2.60.0 ([6ba8b57](https://github.com/omohammed95/test-devops-stack/commit/6ba8b5774a4c5ea3b4190d1b8b8c075be840d0cb))
* upgrade azurerm provider to 2.62.0 ([3812cb8](https://github.com/omohammed95/test-devops-stack/commit/3812cb8dbd184f0447821adef7a11532324057aa))
* upgrade secrets-store-csi-driver-provider-azure to v0.0.22 ([a4dc856](https://github.com/omohammed95/test-devops-stack/commit/a4dc856edbbb791ea83a15bfa020852ce966bb71))
* upgrade Terraform to 1.0.0 ([489a650](https://github.com/omohammed95/test-devops-stack/commit/489a650dc336061593e6c761eb51d9d6ad422477))
...
* use loose dependencies in Terraform modules ([af86e94](https://github.com/omohammed95/test-devops-stack/commit/af86e947012a249f0db6db8cc47a04de7c8ed6f3))
...
* add missing pathType in Ingress ([f22de25](https://github.com/omohammed95/test-devops-stack/commit/f22de25f6f3629e5d15eb1c6fd21526b54538a7d))
* add missing version contraint on null provider ([bda92f1](https://github.com/omohammed95/test-devops-stack/commit/bda92f1a6f8d3152aa553ffd938102eaa1533fed))
...
* **aks:** expose UAI's principal IDs ([c857a98](https://github.com/omohammed95/test-devops-stack/commit/c857a98336365f8a0b0003ec38f5a59a40db2d2b))
...
* **aks:** use local.base_domain instead of var.base_domain ([c417678](https://github.com/omohammed95/test-devops-stack/commit/c417678e34b31011def356998dba864668a5cf59))
...
* argocd secret dependency ([cc5499d](https://github.com/omohammed95/test-devops-stack/commit/cc5499d12779d8f6caa2ed5e365dceab978f63b3))
...
* **argocd:** fix health assessment for Applications ([c7a46cb](https://github.com/omohammed95/test-devops-stack/commit/c7a46cbe0b3aa4cc134c0e20bd034a883c146e3f))
...
* AWS: Filter DNS challenge only on base domain ([e76fd3b](https://github.com/omohammed95/test-devops-stack/commit/e76fd3b8d9e553c07c41876562cdd1fa1f96708b))
* **aws:** don't add nat gateway to cluster_endpoint_public_access_cidrs by default ([54625b0](https://github.com/omohammed95/test-devops-stack/commit/54625b04199b9c9920d5bed9b43c769018093a5b))
* **aws:** use local.base_domain instead of var.base_domain ([2583e09](https://github.com/omohammed95/test-devops-stack/commit/2583e092b27651bfb60508805b972136825681af))
* Azure: Filter DNS challenge only on base domain ([687629e](https://github.com/omohammed95/test-devops-stack/commit/687629e7412127a27c807f320e692daef6536e9d)), closes [#700](https://github.com/omohammed95/test-devops-stack/issues/700)
...
* deploy keys should not be tight to the DevOps Stack ([53d53da](https://github.com/omohammed95/test-devops-stack/commit/53d53da85b1efda828a7d60e31f98325237d9c1c))
...
* **doc:** homogenize name 'DevOps Stack' ([95c9e82](https://github.com/omohammed95/test-devops-stack/commit/95c9e82449bba7f758dec0ebb9be46d8d481fa3b))
...
* **eks:** pass missing arg to function ([5b72586](https://github.com/omohammed95/test-devops-stack/commit/5b725867cd2ef5e95bb148b2cfe678d932843ce8))
...
* fix cluster-issuer deployment refactoring ([0687ce5](https://github.com/omohammed95/test-devops-stack/commit/0687ce5aaf841a1c102662687cdb222c7f98fcac))
...
* fix weird character in template ([6c903c3](https://github.com/omohammed95/test-devops-stack/commit/6c903c34706b21050adc1a3446e7ea374bbad419))
...
* forceNameSpaced was deprecated in favour of forceNamespaced ([aedbcb7](https://github.com/omohammed95/test-devops-stack/commit/aedbcb718d8f92762be18ec83104268acf2c5325))
* format with terraform fmt ([33a499e](https://github.com/omohammed95/test-devops-stack/commit/33a499e2e6f6ec12a75b1d43f402cacbcc409869))
* **k3s:** add missing cluster name in URLs ([093919b](https://github.com/omohammed95/test-devops-stack/commit/093919b5361cff0b64091d239d3db28e3cde68cc))
* **keycloak:** add missing scopes to client ([a86403b](https://github.com/omohammed95/test-devops-stack/commit/a86403b086af1fb518ce739235516423a5ae36cb))
...
* selector in same block ([d53cd33](https://github.com/omohammed95/test-devops-stack/commit/d53cd33c593e85e3a0e69482617aced675a4be69))
...
* **sks:** pass down missing variables to argocd-helm ([#748](https://github.com/omohammed95/test-devops-stack/issues/748)) ([97f3973](https://github.com/omohammed95/test-devops-stack/commit/97f397369e558c0b7a32841cedded4027214f8c5))
...
* update reference adoc files ([475d688](https://github.com/omohammed95/test-devops-stack/commit/475d688e301998fff7f0cf97340defb7b8a0ec94))
* update reference adoc files ([#691](https://github.com/omohammed95/test-devops-stack/issues/691)) ([70a2305](https://github.com/omohammed95/test-devops-stack/commit/70a230554be619e09ee949b4b69aa945d8bec0df))
* upgrade k3s/docker module ([774f3e7](https://github.com/omohammed95/test-devops-stack/commit/774f3e7c61465eadc54c1c634420d4b6c247fe94))
